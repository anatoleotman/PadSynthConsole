...
public:
    ...
    MyPadSynth(PadSynthParameters params) : MyPadSynth(params.N,
                                                        params.samplerate,
...
private:
    ...
    std::pair<int, int> frequency_ratio_;
    float fundamental_frequency_;
    float base_frequency_;

    float harmonic_profile_bandwidth_;
    std::string timbre_type_;

    PadSynthParameters params_;
